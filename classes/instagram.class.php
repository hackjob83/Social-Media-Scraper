...
class Instagram {
   ...
   * @return mixed
   */
  public function getTagMedia($name, $max_id, $limit = 200) {
    return $this->_makeCall('tags/' . $name . '/media/recent', false, array('count' => $limit)); //'max_tag_id' => $max_id,
  }
   ...
   * @return mixed
   */
  public function pagination($obj, $limit = 200) {
